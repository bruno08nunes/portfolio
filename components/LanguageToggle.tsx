...
export default function LanguageToggle() {
    ...
    return (
        <div className="flex gap-4">
            <Link href={pathname} locale="pt" className="max-w-10 rounded-full overflow-hidden">
                <svg
            ...
            <Link href={pathname} locale="en" className="max-w-10 rounded-full overflow-hidden">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    id="flag-icons-us"
                    viewBox="0 0 512 512"
